...
7. The team with the lower odd is more likely to win. Print to the console which team is more likely to win, WITHOUT using an 
...
//6
function printFunction(...players) {
  console.log(`${players.length} goals are scored`);
  

};

printFunction('Davies', 'Muller', 'Lewandowski', 'Kimmich');
printFunction(...game.scored);//jer je u objektu array i moramo da ga razdvojimo
